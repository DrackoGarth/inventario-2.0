<div class="container is-fluid mb-6">
	...
	<h2 class="subtitle"><i class="fas fa-shopping-bag fa-fw"></i> &nbsp; Información de equipo</h2>
</div>
...
<div class="container pb-6 pt-6">
	...
	?>
	<h2 class="title has-text-centered">Datos de la Asignación <?php echo " (".$code.")"; ?></h2>
                ...
                <table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
                    <thead>
                        <tr>
                            ...
                            <th class="has-text-centered" style="display: none;">Precio</th>
                            <th class="has-text-centered" style="display: none;">Subtotal</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
	...
	<div class="columns pb-6 pt-6">
		<p class="has-text-centered full-width">
			...
			<button type="button" style="display: none; class="button is-link is-light is-medium" onclick="print_ticket(\''.APP_URL.'app/pdf/ticket.php?code='.$datos_venta['venta_codigo'].'\')" title="Imprimir ticket Nro. '.$datos_venta['venta_id'].'" ><i class="fas fa-receipt fa-fw"></i> &nbsp; Imprimir ticket</button>';
			?>
		</p>
	</div>
	<?php
